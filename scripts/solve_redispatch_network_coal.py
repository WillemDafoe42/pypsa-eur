...
def solve_redispatch_workflow(c_rate = 0.25):
    ...
    #                                                   plant_potential=plant_potential, scenario="bat", ratio_wind=2.2, ratio_pv=1.38, lcos=0, sec_margin=sec_margin)
    # print("\n\nSave bat_load_to_nc\n\n")
    # n_rd_bat_load.export_to_netcdf(path=export_path + r"/redispatch/" + filename + "_2018_1_coal_50wind_bat_load.nc", export_standard_types=False, least_significant_digit=None)
    # gc.collect()
    ...
    #                                                       plant_potential=plant_potential, scenario="bat", ratio_wind=2.2, ratio_pv=1.38, lcos=0, sec_margin=1)
    # print("\n\nSave bat_supply_to_nc\n\n")
    # n_rd_bat_supply.export_to_netcdf(path=export_path + r"/redispatch/" + filename + "_2018_1_coal_50wind_bat_supply.nc", export_standard_types=False, least_significant_digit=None)
    # gc.collect()
    #
    ...
    #                                                 plant_potential=plant_potential, scenario="bat", ratio_wind=2.2, ratio_pv=1.38, lcos=0, sec_margin=1)
    # print("\n\nSave bat_all_to_nc\n\n")
    # n_rd_bat_all.export_to_netcdf(path=export_path + r"/redispatch/" + filename + "_2018_1_coal_50wind_bat_all.nc", export_standard_types=False, least_significant_digit=None)
    # gc.collect()
    #
    # del n_d_bat_load, n_rd_bat_load, n_d_bat_supply, n_rd_bat_supply, n_d_bat_all, n_rd_bat_all
